  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100/50 flex">
      ...
      <div className={`
        ...
        ${isMobileMenuOpen ? 'opacity-50 blur-sm pointer-events-none scale-98' : 'scale-100'}
      `}>
            ...
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl md:rounded-2xl p-4 md:p-6 text-white shadow-lg">
              <div className="flex items-center space-x-3 md:space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-base text-white/80">Here's what's happening with your bookings</p>
                </div>
              </div>
            </div>
              ...
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <div className="mt-2 md:mt-3">
                    ...
                    <p className="text-xl md:text-2xl font-semibold text-gray-900 mt-0.5 md:mt-1">{stat.value}</p>
                  </div>
                </div>
              ))}
            </div>
