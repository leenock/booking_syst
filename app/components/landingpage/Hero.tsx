        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 h-full">
          ...
          <div className="relative z-10 order-2 lg:order-1 mt-8 lg:mt-0">
            ...
            <div className="relative">
              ...
              Haven of relaxation and rejuvenation that climaxes with beautiful mountain views from the hotel rooftop restaurant. 
              A friendly, warm swimming pool and children play facilities complete the Hotel's family offering of leisure and pleasure.
              </p>
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-8 mt-8 sm:mt-12 pt-8 sm:pt-12 border-t border-gray-700 animate-fade-in-up animation-delay-600">
                <div>
                  <h3 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2 text-amber-400">20+</h3>
                  <p className="text-xs sm:text-sm text-gray-400">Luxury Rooms</p>
                </div>
                <div>
                  <h3 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2 text-amber-400">2+</h3>
                  <p className="text-xs sm:text-sm text-gray-400">Years Experience</p>
                </div>
                <div>
                  <h3 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2 text-amber-400">4.9</h3>
                  <p className="text-xs sm:text-sm text-gray-400">Guest Rating</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative order-1 lg:order-2 h-[300px] sm:h-[400px] md:h-[500px] lg:h-[700px] animate-float">
            ...
            <div className="absolute -bottom-4 sm:-bottom-6 -left-4 sm:-left-6 p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-gray-800 shadow-xl shadow-amber-500/5 backdrop-blur-sm animate-bounce-slow">
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div>
                  <h4 className="text-sm sm:text-base font-medium text-white">Excellent</h4>
                  <p className="text-xs sm:text-sm text-gray-400">2,500+ Reviews</p>
                </div>
              </div>
            </div>
          </div>
